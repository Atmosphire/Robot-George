...
void setRight(void){
    ...
    TA1CCR1 = 150;                         // TA0CCR1 PWM duty cycle for motor A
    TA1CCTL1 |= OUTMOD_7;                  // TA0CCR1 output mode = reset/set for motor A
